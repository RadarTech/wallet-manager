...
var LightWalletUtils = /** @class */ (function () {
    function LightWalletUtils() {
    }
    /**
     ...
     */
    LightWalletUtils.deriveKeyFromPasswordAsync = function (keystore, password) {
     ...
     */
    LightWalletUtils.validatePwDerivedKeyOrThrow = function (pwDerivedKey, keystore) {
        var valid = keystore.isDerivedKeyCorrect(pwDerivedKey);
        if (!valid) {
            throw new Error(types_1.WalletError.InvalidPassword);
        }
    };
    return LightWalletUtils;
}());
exports.LightWalletUtils = LightWalletUtils;
