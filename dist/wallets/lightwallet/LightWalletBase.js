...
var LightWalletBase = /** @class */ (function () {
    function LightWalletBase() {
     ...
     */
    LightWalletBase.prototype.deriveKeyFromPasswordAsync = function (keystore, password) {
     ...
     */
    LightWalletBase.prototype.validatePwDerivedKeyOrThrow = function (pwDerivedKey, keystore) {
        var valid = keystore.isDerivedKeyCorrect(pwDerivedKey);
        if (!valid) {
            throw new Error(types_1.WalletError.InvalidPassword);
        }
    };
    return LightWalletBase;
}());
